import { IntegerEncoding, IntegerEndianness } from "../prelude.ts"

export type ByteLimit = {
  readonly type: "NoLimit"
} | {
  readonly type: "Limit"
...
export type Configuration = {
  integerEndianness: IntegerEndianness.IntegerEndianness,
  integerVariant: IntegerEncoding.IntegerEncoding,
...
export const standard = (byteLimit: number): Configuration => {
  return {
    integerEndianness: IntegerEndianness.Little(),
    integerVariant: IntegerEncoding.VariableLength(),
    byteLimit,
  }
};
...
export const legacy = (byteLimit: number): Configuration => {
  return {
    integerEndianness: IntegerEndianness.Little(),
    integerVariant: IntegerEncoding.FixedLength(),
    byteLimit,
  };
};

/// Makes bincode encode all integer types in big endian.
export const with_big_endian = (me: Configuration): Configuration => {
  return {
    ...me,
    integerEndianness: IntegerEndianness.Big(),
  }
};

/// Makes bincode encode all integer types in little endian.
export const with_little_endian = (me: Configuration): Configuration => {
  return {
    ...me,
    integerEndianness: IntegerEndianness.Little(),
  }
...
export const with_variable_int_encoding = (me: Configuration): Configuration => {
  return {
    ...me,
    integerVariant: IntegerEncoding.VariableLength(),
  };
...
export const with_fixed_int_encoding = (me: Configuration): Configuration => {
  return {
    ...me,
    integerVariant: IntegerEncoding.FixedLength(),
  };
...
// export const with_limit = (me: Configuration, limit: number): Configuration => {
//     generate()
// }

/// Clear the byte limit.
// export const with_no_limit = (me: Configuration): Configuration => NoLimit> {
//     generate()
// }
// }
