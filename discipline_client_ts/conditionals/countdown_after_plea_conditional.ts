...
type StatusDeactivating = {
  ...
  readonly countdown: Countdown.TCountdown,
};
...
const Status_Deactivating = (countdown: Countdown.TCountdown): StatusDeactivating => {
  return {
...
type StatusMatchCases<A, B, C> = {
  Activated: () => A,
  Deactivating: (countdown: Countdown.TCountdown) => B,
  Deactivated: () => C,
};
...
const construct = (duration: Duration.TDuration, status: Status): CountdownAfterPleaConditional => {
...
export const create = (duration: Duration.TDuration): CountdownAfterPleaConditional => {
...
export const deactivate = (me: CountdownAfterPleaConditional, now: DateTime.DateTimeT) => {
...
export const synchronize = (me: CountdownAfterPleaConditional, now: DateTime.DateTimeT) => {
