import { ConditionalVariantEnum, Countdown, CountdownStatus, Duration, Instant, Nullable, Unique } from "@internal/prelude"
...
export type CountdownAfterPleaConditional = Unique<typeof BRAND, "CountdownAfterPleaConditional", RawCountdownAfterPleaConditional>;
